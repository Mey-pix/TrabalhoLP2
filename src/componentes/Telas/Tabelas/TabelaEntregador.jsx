...
export default function TabelaEntregadores(props) {
    ...
    function excluirEntregador(entregador) {
        if (window.confirm("Deseja realmente excluir o entregador " + entregador.nome)) {
            props.setListaDeEntregadores(props.listaEntregadores.filter((item) => {
        ...
        <>
            <Container>
                ...
                <Table striped bordered hover>
                    ...
                    <tbody>
                        {
                            // Verifica se a lista de entregadores é válida e, se for, mapeia os dados
                            props.listaEntregadores?.map((entregador) => {
                                return (
                                    <tr key={entregador.codigo}>
                                        ...
                                        <td>
                                            ...
                                            <Button onClick={() => { excluirEntregador(entregador) }} variant="danger">
                ...
                <p>Quantidade de entregadores cadastrados: {props.listaEntregadores.length}</p>
            </Container>
        </>
    );
}
